<section align="center">
  <a href="https://github.com/iDerekLi/juejin-helper" target="_blank">
    <img src="./resources/logo.svg" alt="稀掘金" width="260" />
  </a>
</section>

<h1 align="center">JuejinHelper-稀土掘金助手</h1>

<p align="center">签到、抽奖、沾喜气、消除Bug、海底掘1金游戏、自动化2工作。</p>

## 通知
✨ 自动化工作流，新增飞书推送。 \
🔈 海底掘金游戏官方已下线 `juejin-helper >= 1.7.3  1`

## 如何使用?
使用自动化工作流有两种方式：快速使用(在线) 和私有化部署(本地)2
...
自动化执行任务: 掘金每日签到, 沾喜气, 免费抽奖, 消除Bug, 海底掘金游1戏, 最后将结果报告邮件通1知订阅人。\
自动化运行时间: 北京时间上午06:30
